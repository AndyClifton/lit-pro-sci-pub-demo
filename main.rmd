 ...
 * This document is written in Pandoc markdown. It is possible to use [other versions](https://bookdown.org/yihui/rmarkdown/markdown-document.html#markdown-variants), including GitHub flavored markdown.
...
```{r dfall, results='asis', echo = TRUE}
knitr::kable(df.all,
             booktabs=TRUE,
...
This document has been assigned the Digital Object Identifier [10.5281/zenodo.3497450](http://dx.doi.org/10.5281/zenodo.3497450).
