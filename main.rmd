...
output:
  ...
  md_document:
    ...
    number_sections: true
    pandoc args: ["--filter=pandoc-secnos"]
...
I can also include equations, and reference them (e.g. Equation \@ref(eq:eq)). This gets weird, because for the best results with equations we should now use LaTeX-style `\begin{equation}... \end{equation}`:
